...
const ButtonShapeIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg preserveAspectRatio='none' viewBox='0 0 44 29' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
    <rect x={7.5} y={0.5} width={36} height={28} rx={8} fill='#E6436D' />
    <rect x={0.5} y={0.5} width={36} height={28} rx={8} fill='#65D2E9' />
    <rect x={4} y={0.5} width={36} height={28} rx={8} fill='#161722' />
    <path
...
const Memo = memo(ButtonShapeIcon);
export { Memo as ButtonShapeIcon };
